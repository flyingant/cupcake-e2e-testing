...
// https://teamsolace.atlassian.net/browse/CC-2580
class TestCase extends MockableTestCase {
  ...
  createTestSteps(): void {
    ...
    this.addTestStep(`Click the X button that the message will be gone`, async () => {
...
new TestCase('CC-269', 'Message Clinic name saved successfully is displayed with the blue background and go away after 5 seconds and/or when user clicks on X icon');
