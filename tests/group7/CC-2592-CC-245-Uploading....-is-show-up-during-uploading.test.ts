...
// https://teamsolace.atlassian.net/browse/CC-2592
class TestCase extends MockableTestCase {
  ...
  createTestSteps(): void {
    ...
    this.addTestStep(`Verify that on selecting logo file user can see 'Uploading ..."`, async () => {
...
new TestCase('CC-245', `'Uploading....' is show up during uploading`);
