...
// https://teamsolace.atlassian.net/browse/CC-2557
...
new TestCase('CC-1037', `'Check' icon is displayed, if Pre-Auth is completed and the outcome is successful on Patient detail screen`);
