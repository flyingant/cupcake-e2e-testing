...
// https://teamsolace.atlassian.net/browse/CC-2434
class TestCase extends MockableTestCase {
  createTestSteps(): void {
    ...
    this.addTestStep(`Verify if Schedule date in 'PSY.' column, is displayed as a blue calendar`, async () => {
      const SVG = await this.dashboardPage.getPasychEvalPendingIconSVG();
...
new TestCase('CC-638', `Scheduled date in Education column is a blue calendar`);
