...
// https://teamsolace.atlassian.net/browse/CC-2354
...
new TestCase(
  "CC-221",
  `If coordinator selected “Yes, Cancel“ option, no data is saved from this screen, and add patient flow is removed`
);