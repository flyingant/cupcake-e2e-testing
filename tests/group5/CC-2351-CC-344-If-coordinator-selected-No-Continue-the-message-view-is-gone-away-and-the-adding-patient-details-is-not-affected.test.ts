...
// https://teamsolace.atlassian.net/browse/CC-2351
...
new TestCase(
  "CC-344",
  `If coordinator selected “No, Continue“, the message view is gone away and the adding patient details is not affected`
);