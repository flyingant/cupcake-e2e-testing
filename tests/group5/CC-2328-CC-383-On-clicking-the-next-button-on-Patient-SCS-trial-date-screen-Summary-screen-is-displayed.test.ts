...
// https://teamsolace.atlassian.net/browse/CC-2328
class TestCase extends MockableTestCase {
  ...
  createTestSteps(): void {
    ...
    this.addTestStep(`Click on the "->" button on the patient’s referring page`, async () => {
...
new TestCase(
  "CC-383",
  `On clicking the next button on Patient SCS trial date screen, ”Summary” screen is displayed.`
);