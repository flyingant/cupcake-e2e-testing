...
// https://teamsolace.atlassian.net/browse/CC-2370
...
new TestCase(
  "CC-336",
  `Once the coordinator clicked on “YES, CANCEL“, no data is saved from this screen, add patient flow is removed and the previous screen is displayed`
);