...
// https://teamsolace.atlassian.net/browse/CC-2369
...
new TestCase(
  "CC-452",
  `Message that the data will be lost is shown when coordinator closes the screen of selecting stage in SCS journey`
);