...
// https://teamsolace.atlassian.net/browse/CC-2418
class TestCase extends MockableTestCase {
  createTestSteps(): void {
    ...
    this.addTestStep(`Go to dashboard and verify the Schedule for implant date column`, async () => {
...
new TestCase('CC-547', `Coordinator can cancel out of the date picker and can come back to the dashboard and see the schedule button again`);
